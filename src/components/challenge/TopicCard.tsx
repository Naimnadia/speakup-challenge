...
const TopicCard: React.FC<TopicCardProps> = ({
  ...
  return <Card className="border shadow-md">
      <CardHeader className="pb-2">
        <div className="flex justify-between items-start">
          <CardTitle className="flex items-center text-lg font-bold text-[#d60d82]">
      ...
      <CardContent>
        ...
        {tips.length > 0 && <div className="space-y-2">
            ...
            <ul className="space-y-1 text-sm text-gray-600">
              {tips.map((tip, index) => <li key={index} className="flex items-start">
