              ...
              <div className="lg:col-span-2 space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {dailyChallenges.map((challenge, index) => <DailyChallenge key={index} title={challenge.title} description={challenge.description} difficulty={challenge.difficulty as 'easy' | 'medium' | 'hard'} timeEstimate={challenge.timeEstimate} xpReward={challenge.xpReward} onStart={handleStartChallenge} />)}
                  </div>
                </div>
