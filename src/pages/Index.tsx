...
const Index = () => {
  ...
  const mockLeaderboard = [
    { id: 1, name: 'Sarah Johnson', xp: 1250, position: 1, isCurrentUser: false },
    { id: 2, name: 'David Chen', xp: 1120, position: 2, isCurrentUser: false },
    { id: 3, name: 'You', xp: 980, position: 3, isCurrentUser: true },
    { id: 4, name: 'Michael Brown', xp: 840, position: 4, isCurrentUser: false },
    { id: 5, name: 'Emily Davis', xp: 720, position: 5, isCurrentUser: false },
  ];
